...
if (!is_array($blacklist) || strlen(implode($blacklist)) == 0) {
    update_option('fastvelocity_min_blacklist', implode("\n", $exc));
}
...
if (!is_array($ignorelist) || strlen(implode($ignorelist)) == 0) {
    update_option('fastvelocity_min_ignorelist', implode("\n", $exc));
}
...
# get active tab, set default
    ...
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper wp-clearfix">
            <a href="?page=fastvelocity-min&tab=status"
               class="nav-tab <?php echo $active_tab == 'status' ? 'nav-tab-active' : ''; ?>">Status</a>
            <a href="?page=fastvelocity-min&tab=settings"
               class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>">Settings</a>
            <a href="?page=fastvelocity-min&tab=pro"
               class="nav-tab <?php echo $active_tab == 'pro' ? 'nav-tab-active' : ''; ?>">Pro</a>
            <a href="?page=fastvelocity-min&tab=server"
               class="nav-tab <?php echo $active_tab == 'server' ? 'nav-tab-active' : ''; ?>">Server Info</a>
            <a href="?page=fastvelocity-min&tab=help"
                        ...
                        <div class="meta-box">
                            ...
                            <div class="postbox" id="tab-purge">
                                ...
                                <div class="inside" id="fastvelocity_min_topbtns">
                                    <ul class="processed">
                                        <li id="purgeall-row">
                                            <span class="filename">Purge FVM cache directory (<span
                                                        id="fvm_cache_size"><?php echo fastvelocity_get_cachestats(); ?></span>)</span>
                                            <span class="actions">
							<form method="post" id="fastvelocity_min_clearall"
                                  action="<?php echo admin_url('options-general.php?page=fastvelocity-min&tab=status'); ?>">
        ...
        <?php if ($active_tab == 'settings') { ?>
            <form method="post" action="options.php">
                ...
                <p class="fvm-bold-green">These options are generaly safe to edit as needed. If you use a cache plugin,
                    kindly purge all your caches once you're done with the changes.</p>
                ...
                <table class="form-table fvm-settings">
                        ...
                        <td>
                            ...
                            <fieldset>
                                <label for="fastvelocity_min_enable_purgemenu">
                                    <input name="fastvelocity_min_enable_purgemenu" type="checkbox"
                                           id="fastvelocity_min_enable_purgemenu"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_enable_purgemenu'), true, false); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="fvm-bold-green fvm-rowintro">It's recommended that you enable this, if your theme
                                comes with some sort of visual frontend editor.</p>
                            <fieldset>
                                <label for="fastvelocity_min_fvm_fix_editor">
                                    <input name="fastvelocity_min_fvm_fix_editor" type="checkbox"
                                           id="fastvelocity_min_fvm_fix_editor"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_fvm_fix_editor'), true, false); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <p class="fvm-bold-green fvm-rowintro">You may need to force http or https, for some CDN
                                plugins to work:</p>
                            <fieldset>
                                <label><input type="radio" name="fastvelocity_min_default_protocol"
                                              value="dynamic" <?php echo $a; ?>> Use the dynamic "//"
                                    protocol</label><br>
                                <label><input type="radio" name="fastvelocity_min_default_protocol"
                                              value="http"<?php echo $b; ?>> Force HTTP urls</label><br>
                                <label><input type="radio" name="fastvelocity_min_default_protocol"
                                              value="https"<?php echo $c; ?>> Force HTTPS urls</span></label><br>
                            </fieldset>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="fvm-bold-green fvm-rowintro">The HTML minification is ON by default, but you
                                can:</p>

                            <fieldset>
                                <label for="fastvelocity_min_skip_html_minification">
                                    <input name="fastvelocity_min_skip_html_minification" type="checkbox"
                                           id="fastvelocity_min_skip_html_minification"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_skip_html_minification'), true, false); ?>>
                                ...
                                <label for="fastvelocity_min_strip_htmlcomments">
                                    <input name="fastvelocity_min_strip_htmlcomments" type="checkbox"
                                           id="fastvelocity_min_strip_htmlcomments"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_strip_htmlcomments'), true, false); ?>>
                                ...
                                <label for="fastvelocity_min_use_alt_html_minification">
                                    <input name="fastvelocity_min_use_alt_html_minification" type="checkbox"
                                           id="fastvelocity_min_use_alt_html_minification"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_use_alt_html_minification'), true, false); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="fvm-bold-green fvm-rowintro">It's recommended that you enable the "Inline Google
                                Fonts CSS" option.</p>
                            <fieldset>
                                <label for="fastvelocity_min_skip_emoji_removal">
                                    <input name="fastvelocity_min_skip_emoji_removal" type="checkbox"
                                           id="fastvelocity_min_skip_emoji_removal" class="jsprocessor"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_skip_emoji_removal'), true, false); ?> >
                                ...
                                <label for="fastvelocity_min_skip_google_fonts">
                                    <input name="fastvelocity_min_skip_google_fonts" type="checkbox"
                                           id="fastvelocity_min_skip_google_fonts"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_skip_google_fonts'), true, false); ?> >
                                ...
                                <label for="fastvelocity_min_force_inline_googlefonts">
                                    <input name="fastvelocity_min_force_inline_googlefonts" type="checkbox"
                                           id="fastvelocity_min_force_inline_googlefonts"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_force_inline_googlefonts'), true, false); ?> >
                                    Inline Google Fonts CSS <span class="note-info">[ If selected, Google Fonts CSS code will be inlined using "*.woof" format - NOTE: IE9+ and <a
                                                target="_blank" href="http://caniuse.com/#feat=woff">modern browsers</a> only]</span></label>
                                <br/>

                                <label for="fastvelocity_min_remove_googlefonts">
                                    <input name="fastvelocity_min_remove_googlefonts" type="checkbox"
                                           id="fastvelocity_min_remove_googlefonts"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_remove_googlefonts'), true, false); ?> >
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="fvm-bold-green fvm-rowintro">It's recommended that you Inline all CSS files, if
                                they are small enough.</p>

                            <fieldset>
                                <label for="fastvelocity_min_disable_css_merge">
                                    <input name="fastvelocity_min_disable_css_merge" type="checkbox"
                                           id="fastvelocity_min_disable_css_merge"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_disable_css_merge'), true, false); ?>>
                                ...
                                <label for="fastvelocity_min_disable_css_minification">
                                    <input name="fastvelocity_min_disable_css_minification" type="checkbox"
                                           id="fastvelocity_min_disable_css_minification"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_disable_css_minification'), true, false); ?>>
                                ...
                                <label for="fastvelocity_min_skip_cssorder">
                                    <input name="fastvelocity_min_skip_cssorder" type="checkbox"
                                           id="fastvelocity_min_skip_cssorder"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_skip_cssorder'), true, false); ?> >
                                ...
                                <label for="fastvelocity_min_remove_print_mediatypes">
                                    <input name="fastvelocity_min_remove_print_mediatypes" type="checkbox"
                                           id="fastvelocity_min_remove_print_mediatypes"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_remove_print_mediatypes'), true, false); ?> >
                                ...
                                <label for="fastvelocity_min_force_inline_css">
                                    <input name="fastvelocity_min_force_inline_css" type="checkbox"
                                           id="fastvelocity_min_force_inline_css"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_force_inline_css'), true, false); ?>>
                                ...
                                <label for="fastvelocity_min_force_inline_css_footer">
                                    <input name="fastvelocity_min_force_inline_css_footer" type="checkbox"
                                           id="fastvelocity_min_force_inline_css_footer"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_force_inline_css_footer'), true, false); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="fvm-bold-green fvm-rowintro">Try to disable minification (and purge the cache), if
                                you have trouble with JavaScript in the frontend.</p>
                            <fieldset>
                                <label for="fastvelocity_min_disable_js_merge">
                                    <input name="fastvelocity_min_disable_js_merge" type="checkbox"
                                           id="fastvelocity_min_disable_js_merge"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_disable_js_merge'), true, false); ?> >
                                ...
                                if (function_exists('exec') && exec('command -v java >/dev/null && echo "yes" || echo "no"') == 'yes') {
                                    ...
                                    <label for="fastvelocity_min_use_yui">
                                        <input name="fastvelocity_min_use_yui" type="checkbox"
                                               id="fastvelocity_min_use_yui" class="jsprocessor"
                                               value="1" <?php echo checked(1 == get_option('fastvelocity_min_use_yui'), true, false); ?> >
                                ...
                                <label for="fastvelocity_min_disable_js_minification">
                                    <input name="fastvelocity_min_disable_js_minification" type="checkbox"
                                           id="fastvelocity_min_disable_js_minification"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_disable_js_minification'), true, false); ?> >
                ...
                <p class="fvm-bold-green">It's highly recommended that you only select the options below if you're an
                    advanced user or developer and understand what these options mean.</p>
                ...
                <table class="form-table fvm-settings">
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text"><span>Render-blocking</span></legend>

                                <p class="fvm-bold-green fvm-rowintro">Some themes and plugins "need" render blocking
                                    scripts to work, so please take a look at the dev console for errors.</p>
                                <label for="fastvelocity_min_enable_defer_js">
                                    <input name="fastvelocity_min_enable_defer_js" type="checkbox"
                                           id="fastvelocity_min_enable_defer_js"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_enable_defer_js'), true, false); ?>>
                                ...
                                <label for="fastvelocity_min_defer_for_pagespeed">
                                    <input name="fastvelocity_min_defer_for_pagespeed" type="checkbox"
                                           id="fastvelocity_min_defer_for_pagespeed"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_defer_for_pagespeed'), true, false); ?>>
                                    Enable defer of JS for Pagespeed Insights <span class="note-info">[ Defer JS files for Pagespeed Insights only, <a
                                                target="_blank"
                                                href="https://www.chromestatus.com/feature/5718547946799104">except external scripts</a> (avoid using a CDN for JS files) ]</span></label>
                                <br/>

                                <label for="fastvelocity_min_defer_for_pagespeed_optimize">
                                    <input name="fastvelocity_min_defer_for_pagespeed_optimize" type="checkbox"
                                           id="fastvelocity_min_defer_for_pagespeed_optimize"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_defer_for_pagespeed_optimize'), true, false); ?>>
                                ...
                                <label for="fastvelocity_min_exclude_defer_jquery">
                                    <input name="fastvelocity_min_exclude_defer_jquery" type="checkbox"
                                           id="fastvelocity_min_exclude_defer_jquery"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_exclude_defer_jquery'), true, false); ?> >
                                ...
                                <label for="fastvelocity_min_exclude_defer_login">
                                    <input name="fastvelocity_min_exclude_defer_login" type="checkbox"
                                           id="fastvelocity_min_exclude_defer_login"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_exclude_defer_login'), true, false); ?> >
                ...
                <p class="fvm-bold-green">You can use this section to exclude certain CSS or JS files from being
                    processed in case of conflicts while merging.<br/>Read the HELP section for information on why you
                    may need to use this.</p>
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                ...
                                <p>
                                    <textarea name="fastvelocity_min_ignore" rows="10" cols="50"
                                              id="fastvelocity_min_ignore" class="large-text code"
                                              placeholder="ex: /wp-includes/js/jquery/jquery.js"><?php echo get_option('fastvelocity_min_ignore'); ?></textarea>
                                </p>
                                <p class="description">[ Your own list of js /css files to ignore with wildcard support
                                    (read the faqs) ]</p>
                            </fieldset>
                        </td>
                    </tr>
                ...
                <p class="fvm-bold-green">If the "Enable defer of JS for Pagespeed Insights" option is enabled, JS and
                    CSS files will not be loaded from the CDN.<br/>However, the static assets used inside the CSS and JS
                    files will load from the CDN directly.</p>
                        ...
                        <td>
                            <fieldset>
                                <label for="fastvelocity_min_fvm_cdn_url">
                                    <p><input type="text" name="fastvelocity_min_fvm_cdn_url"
                                              id="fastvelocity_min_fvm_cdn_url"
                                              value="<?php echo get_option('fastvelocity_min_fvm_cdn_url', ''); ?>"
                                              size="80"/></p>
                                    <p class="description">[ Load the generated CSS and JS urls (only) from your cdn
                                        domain name, ie: cdn.example.com ]</p></label>
                            </fieldset>
                        </td>
                    </tr>
                    </tbody>
                ...
                <table class="form-table fvm-settings">
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text"><span>Preconnect</span></legend>
                                <label for="fastvelocity_min_preconnect"><span class="fvm-label-pad">Insert one domain name url per line:</span></label>
                                <p>
                                    <textarea name="fastvelocity_min_preconnect" rows="10" cols="50"
                                              id="fastvelocity_min_preconnect" class="large-text code"
                                              placeholder="ex: //fonts.gstatic.com"><?php echo get_option('fastvelocity_min_preconnect'); ?></textarea>
                                </p>
                                <p class="description">[ Use only the necessary domain names, such as remote font domain
                                    names, ex: //fonts.gstatic.com ]</p>
                            </fieldset>
                        </td>
                    </tr>
                ...
                <p class="fvm-bold-green">Use this only for images above the fold that exist in all pages, such as your
                    logo.</p>
                ...
                <table class="form-table fvm-settings">
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text"><span>Preload Images</span></legend>
                                <label for="fastvelocity_min_preload"><span class="fvm-label-pad">Insert one image url per line:</span></label>
                                <p>
                                    <textarea name="fastvelocity_min_preload" rows="10" cols="50"
                                              id="fastvelocity_min_preload" class="large-text code"
                                              placeholder="ex: //yoursite.com/wp-content/plugins/some-slider/large.img"><?php echo get_option('fastvelocity_min_preload'); ?></textarea>
                                </p>
                                <p class="description">[ Use only for large images that first load above the fold. Read
                ...
                <p class="submit"><input type="submit" name="fastvelocity_min_save_options"
                                         id="fastvelocity_min_save_options" class="button button-primary"
        ...
        <?php if ($active_tab == 'pro') { ?>
            ...
            <form method="post" action="options.php">
                <?php settings_fields('fvm-group-pro');
                do_settings_sections('fvm-group-pro'); ?>


                <div style="height: 20px;"></div>
                <h2 class="title">Pro Optimization</h2>
                <p class="fvm-bold-green">Do NOT touch these settings, unless you're a developer that understands
                    exactly what this does.<br/>This section is experimental and may or may not be removed or
                    restructured in the future.</p>
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                ...
                                <p>
                                    <textarea name="fastvelocity_min_critical_path_css" rows="10" cols="50"
                                              id="fastvelocity_min_critical_path_css" class="large-text code"
                                              placeholder="your css code here"><?php echo get_option('fastvelocity_min_critical_path_css'); ?></textarea>
                                </p>
                                <p class="description">[ Use this if you're familiar with <a target="_blank"
                                                                                             href="https://github.com/giakki/uncss">UnCSS</a>
                                    or have the correct critical path css. ]</p>
                            </fieldset>
                        </td>
                    </tr>
                        ...
                        <td>
                            <fieldset>
                                <label for="fastvelocity_min_fvm_removecss">
                                    <input name="fastvelocity_min_fvm_removecss" type="checkbox"
                                           id="fastvelocity_min_fvm_removecss"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_fvm_removecss'), true, false); ?>>
                ...
                <p class="fvm-bold-green">If you have multiple css files per media type, they may load out of order and
                    break your design.<br/>Pagespeed will still complain about render blocking, until you have the
                    correct critical path CSS code.</p>
                        ...
                        <td>
                            <fieldset>
                                <label for="fastvelocity_min_loadcss">
                                    <input name="fastvelocity_min_loadcss" type="checkbox" id="fastvelocity_min_loadcss"
                                           value="1" <?php echo checked(1 == get_option('fastvelocity_min_loadcss'), true, false); ?>>
                ...
                <p class="fvm-bold-green">You can use this section to edit or change our default exclusions, as well as
                    to add your own.<br/>It's recommeded that you use the Ignore List before touching these settings.
                </p>
                ...
                <table class="form-table fvm-settings">
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset><label for="blacklist_keys"><span class="fvm-label-pad">List of external domains that can be fetched and merged together:</span></label>
                                <p>
                                    <textarea name="fastvelocity_min_merge_allowed_urls" rows="10" cols="50"
                                              id="fastvelocity_min_merge_allowed_urls" class="large-text code"
                                              placeholder="ex: example.com"><?php echo get_option('fastvelocity_min_merge_allowed_urls'); ?></textarea>
                                </p>
                                <p class="description">[ Add any external "domains" for JS or CSS files than can be
                                    merged fetched and merged together by FVM, ie: example.com ]</p>
                            </fieldset>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset><label for="blacklist_keys"><span class="fvm-label-pad">Do not edit, if you're not sure what this is:</span></label>
                                <p>
                                    <textarea name="fastvelocity_min_ignorelist" rows="10" cols="50"
                                              id="fastvelocity_min_ignorelist" class="large-text code"
                                              placeholder="ex: /wp-includes/js/jquery/jquery.js"><?php echo get_option('fastvelocity_min_ignorelist'); ?></textarea>
                                </p>
                                <p class="description">[ Files that have been reported by other users to cause trouble
                                    when merged and that should always be ignored ]</p>
                            </fieldset>
                        </td>
                    </tr>
                    </tbody>
                ...
                <table class="form-table fvm-settings">
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset><label for="blacklist_keys"><span class="fvm-label-pad">Do not edit, if you're not sure what this is:</span></label>
                                <p>
                                    <textarea name="fastvelocity_min_blacklist" rows="10" cols="50"
                                              id="fastvelocity_min_blacklist" class="large-text code"
                                              placeholder="ex: /wp-includes/js/jquery/jquery.js"><?php echo get_option('fastvelocity_min_blacklist'); ?></textarea>
                                </p>
                                <p class="description">[ Usually, any IE css /js files that should always be ignored
                                    without incrementing the groups ]</p>
                            </fieldset>
                        </td>
                    </tr>
                    </tbody>
                ...
                <p class="fvm-bold-green">If your server blocks JavaScript on the uploads directory, you can change
                    "wp-content/uploads" with "wp-content/cache" or other allowed public directory.</p>
                <table class="form-table fvm-settings">
                    <tbody>
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                <label for="fastvelocity_min_change_cache_path">
                                    <p><input type="text" name="fastvelocity_min_change_cache_path"
                                              id="fastvelocity_min_change_cache_path"
                                              value="<?php echo get_option('fastvelocity_min_change_cache_path', ''); ?>"
                                              size="80"/></p>
                                    <p class="description">[ Default cache path
                                        is: <?php echo rtrim(wp_upload_dir()['basedir'], '/'); ?> ]</p>
                                </label>
                            </fieldset>
                        </td>
                    </tr>
                        ...
                        <td>
                            <fieldset>
                                <label for="fastvelocity_min_change_cache_base_url">
                                    <p><input type="text" name="fastvelocity_min_change_cache_base_url"
                                              id="fastvelocity_min_change_cache_base_url"
                                              value="<?php echo get_option('fastvelocity_min_change_cache_base_url', ''); ?>"
                                              size="80"/></p>
                                    <p class="description">[ Default cache base url
                                        is: <?php echo rtrim(fvm_get_protocol(wp_upload_dir()['baseurl']), '/'); ?>
                                        ]</p>
                                </label>
                            </fieldset>
                        </td>
            ...
            if (!file_exists($file)) {
                ...
                foreach ($header[$i]['handles'] as $handle) :
                    if (!empty($wp_scripts->registered[$handle]->src)) {
                        ...
                        $newcode = false;
                        $newcode = fvm_get_transient($tkey);
                        if ($newcode === false) {
...
# return if in any ignore list
    if (count($nignore) > 0 && fastvelocity_min_in_arrayi($src, $nignore)) {
        return $tag;
    }
    if (count($blacklist) > 0 && fastvelocity_min_in_arrayi($src, $blacklist)) {
        return $tag;
    }
    if (count($ignorelist) > 0 && fastvelocity_min_in_arrayi($src, $ignorelist)) {
        return $tag;
    }
...
# https://css-tricks.com/prefetching-preloading-prebrowsing/
    if (count($preconnect) > 0) {
        $a = array();
        foreach ($preconnect as $b) {
            if (!empty($b)) {
                $a[] = '<link href="' . str_ireplace(array('http://', 'https://'), '//', $b) . '" rel="preconnect">';
            }
        }
        if (count($a) > 0) {
            $meta[] = implode('', $a);
